                ...
                <Grid verticalAlign='middle' textAlign='center'>
                  <Grid.Column>
                    ...
                    <div class="contentContainer" style={{padding: '20px', marginTop: '10px', textAlign: 'left'}}>
                      ...
                      <p style={{ textAlign: 'left', fontSize: '1.33em', paddingLeft: '80px', marginTop: '45px', width: '800px' }}>
                        Authorize MANA transfers on Matic. When the Metamask popup appears, select ‘edit’, select ‘advanced’, set the gas price to 0, and click ‘save’ before confirming the transaction.
                      </p>
              ...
              <Grid verticalAlign='middle' textAlign='center'>
                <Grid.Column>
                  ...
                  <div class="contentContainer" style={{padding: '20px', marginTop: '10px', textAlign: 'left'}}>
                    ...
                    <p style={{ textAlign: 'left', fontSize: '1.33em', paddingLeft: '80px', marginTop: '45px', width: '800px' }}>
                      On your Metamask extension, open the 'Main Ethereum Network' dropdown menu and select 'Custom RPC'. Fill in 'Matic Testnet' as Network name and <span style={{fontStyle:'italic'}}>https://testnet2.matic.network</span> as New RPC URL and select 'Save'.
                    </p>
