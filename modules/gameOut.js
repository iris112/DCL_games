...
module.exports.returnData = async result => {
  ...
  try {
    ...
    if (!playData) {
      console.log(
        "can't find roulette play info : machinID = " + machineIDPadded,
        ' txid = ',
    ...
    if (playerData) {
      ...
      console.log(
        "can't find roulette player info : address = " + playData.address
      );
    }
    ...
    if (machineTotalData) {
      ...
      if (machineTotalData)
        console.log('roulette machinetotalinfo updating success');
      else console.log('roulette machinetotalinfo updating failed');
    } else {
      console.log(
        "can't find roulette machine total info : machineID = " +
          machineIDPadded
      );
    }
  } catch (e) {
