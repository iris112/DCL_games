...
contract Roulette {
    ...
    function betSingle(uint _number, address _player, uint _value) external transactionMustContainValue() bankMustBeAbleToPayForBetType(BetType.Single) {
    ...
    function betEven(address _player, uint _value) external transactionMustContainValue() bankMustBeAbleToPayForBetType(BetType.Even) {
        bets.push(Bet({
    ...
    function betOdd(address _player, uint _value) external transactionMustContainValue() bankMustBeAbleToPayForBetType(BetType.Even) {
        bets.push(Bet({
            betType: BetType.Odd,
            player: _player,
            number: 0,
    ...
    function betRed(address _player, uint _value) external transactionMustContainValue() bankMustBeAbleToPayForBetType(BetType.Red) {
        bets.push(Bet({
            betType: BetType.Red,
            player: _player,
            number: 0,
    ...
    function betBlack(address _player, uint _value) external transactionMustContainValue() bankMustBeAbleToPayForBetType(BetType.Black) {
        bets.push(Bet({
    ...
    function betHigh(address _player, uint _value) external transactionMustContainValue() bankMustBeAbleToPayForBetType(BetType.High) {
        bets.push(Bet({
    ...
    function betLow(address _player, uint _value) external transactionMustContainValue() bankMustBeAbleToPayForBetType(BetType.Low) {
        bets.push(Bet({
            betType: BetType.Low,
            player: _player,
            number: 0,
    ...
    function betColumn(uint _column, address _player, uint _value) external transactionMustContainValue() bankMustBeAbleToPayForBetType(BetType.Column) {
    ...
    function betDozen(uint _dozen, address _player, uint _value) external transactionMustContainValue() bankMustBeAbleToPayForBetType(BetType.Dozen) {
