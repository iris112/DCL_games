...
import { Icon, Image, Menu, Search, Container, Segment, Grid, Popup, Message, Header } from "semantic-ui-react";
    ...
    return (
      <Segment className='nav-mobile' style={{ marginTop: '0em', paddingTop: '0em', marginBottom: '0em', paddingBottom: '0em' }}>
        ...
        <div className='navbar2'>
          ...
          >
            <Container style={{ paddingLeft: '14px', paddingRight: '0px' }}>
              ...
              <Menu.Menu className='nav-buttons' position='right' style={{ paddingRight: '6px' }}>
                ...
                />
                <Popup
                  trigger={<Menu.Item className='nav-text' style={{ marginRight: '1px' }}>VR</Menu.Item>}
