...
function updateUserIndexing(address, page, data) {
    return __awaiter(this, void 0, void 0, function* () {
        let ret = yield userIndexingsModel
...
function updateUser(address, data) {
    return __awaiter(this, void 0, void 0, function* () {
        let ret = yield userAddressesModel
...
function findAllTransaction(data, opts = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let ret = yield userTransactionsModel
...
function updateUserTrading(txHash, data) {
    return __awaiter(this, void 0, void 0, function* () {
        let ret = yield userTradingsModel
...
function findPlayInfo(data) {
    return __awaiter(this, void 0, void 0, function* () {
        var tx = yield userPlayInfosModel
            .findOne(data)
            .sort({ createdAt: -1 })
            .exec();
        if (tx)
...
function updatePlayerInfo(filter, data) {
    return __awaiter(this, void 0, void 0, function* () {
        let ret = yield userPlayerInfosModel
            .findOneAndUpdate(filter, data, { new: true })
            .exec();
        if (ret)
            return ret.toJSON();
...
function updateMachineTotalInfo(filter, data) {
    return __awaiter(this, void 0, void 0, function* () {
        let ret = yield machineTotalInfosModel
            .findOneAndUpdate(filter, data, { new: true })
            .exec();
        if (ret)
            return ret.toJSON();
